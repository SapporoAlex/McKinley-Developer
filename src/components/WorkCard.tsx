  ...
  return (
    <>
      ...
      {isModalMounted &&
        createPortal(
          <div
            className={`work-card-modal-overlay ${isModalClosing ? "work-card-modal-overlay--closing" : ""}`}
            onClick={closeModal}
          >
            <div
            ...
            >
              ...
              <div className="work-card-modal__scroll" ref={modalRef}>
                <div className="work-card-modal__image-frame">
                  <img
                    className="work-card-modal__image"
                    src={img}
                    alt={title}
                  />
                </div>
                <div className="work-card-modal__body">
                  ...
                  {date && (
                    <span className="work-card-modal__date">{date}</span>
                  )}
